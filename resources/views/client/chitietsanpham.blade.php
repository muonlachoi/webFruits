...
<div class="fruit-details">
    <div class="fruit-details__list">
        <div >
        <h1 style="text-align:center;padding-top:50px;font-size:40px">Chi tiết sản phẩm</h1>
        </div>
        ...
        <div class="fruit-details__item">
            ...
            <div class="fruit-details__content">
                ...
                @if(Auth::check())
                <button class="fruit-details__btn"><a href="{{url('add-to-cart/'.$item->mahh)}}">Thêm vào giỏ hàng</a></button>
                @else
