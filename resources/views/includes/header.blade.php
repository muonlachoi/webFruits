...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/ap7.css')}}">
                ...
                <ul class="fruits-menu__list" style="margin-left:12px">
                    ...
                    <li>
                        <div class="fruits-menu__dropdown">
                            <a href="{{url('qua-tang')}}">Quà Tặng <i class="fa-solid fa-caret-down"></i></a>
                            <div class="fruits-menu__dropdown-list">
                                <div class="fruits-menu__dropdown-item">
                                    <a href="{{url('gio-trai-cay')}}" class="fruits-menu__dropdown-text">GIỎ TRÁI CÂY</a>
                                </div>
                                <div class="fruits-menu__dropdown-item">
                                    <a href="{{url('hop-qua-trai-cay')}}" class="fruits-menu__dropdown-text">HỘP QUÀ TRÁI CÂY</a>
                                </div>
                                <div class="fruits-menu__dropdown-item">
                                    <a href="{{url('khay-trai-cay')}}" class="fruits-menu__dropdown-text">KHAY TRÁI CÂY</a>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="fruits-menu__dropdown">
                            <a href="{{url('trai-cay')}}">Trái Cây <i class="fa-solid fa-caret-down"></i></a>
                            <div class="fruits-menu__dropdown-list">
                                <div class="fruits-menu__dropdown-item">
                                    <a href="{{url('trai-cay-kho')}}" class="fruits-menu__dropdown-text">Trái Cây Khô</a>
                                </div>
                                <div class="fruits-menu__dropdown-item">
                                    <a href="{{url('trai-cay-tuoi')}}" class="fruits-menu__dropdown-text">Trái Cây Tươi</a>
                                </div>
                            </div>
                    </li>
      ...
      <form class="d-flex">
        ...
        <button class="btn btn-outline-success" type="submit">Search</button>
                ...
                <div class="fruits-menu__cart">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="font-size: 12px;padding: 10px 20px;border-radius:10px;">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @if(session('cart'))
                                    <a href="{{ url('cart') }}" class="btn btn-primary btn-block" style="font-size:20px">View all</a>
                                    <button style="font-size:20px" class="btn btn-danger" style="color:#fff;    "><a style=" text-decoration: none;color:#fff" href="{{url('/thanh-toan/'.$total)}}" >Thanh toán</a></button>
                                    @endif
                                </div>
                            </div>
                        </div>
